...
const data: Slide[] = [
  {
    title: 'Find surplus food near you — in real time.',
    subtitle: 'Local businesses post extra food. You get notified instantly.',
    image: require('../assets/images/ReceiptOnboard1.png'),
  },
  {
    title: 'Private. Fair. Secure.',
    image: require('../assets/images/ReceiptOnboard2.png'),
    bulletPoints: [
      'Your identity stays private',
      'Requests are allocated fairly',
      'Pickup verified with secure PIN',
    ],
  },
]

export default function ReceiptOnBoardScreen() {
